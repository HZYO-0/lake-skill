"""Configuration management for LakeSkill."""
...
class LakeSkillConfig(BaseModel):
    """Main LakeSkill configuration."""

    project_name: str = "lake-skill"
...
def load_config(config_path: Optional[Path] = None) -> LakeSkillConfig:
    ...
    if config_path.exists():
        ...
        if data:
            return LakeSkillConfig(**data)

    return LakeSkillConfig()


def save_config(config: LakeSkillConfig, config_path: Path) -> None:
